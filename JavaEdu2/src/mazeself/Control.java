...
public class Control {
	...
	ArrayList<Player> player = new ArrayList<Player>();	// player 객체를 담을 'p' ArrayList 선언 
	Room[][] map = new Room[5][4];						// Room 객체를 담을 2차원 'map' 배열 선언
	...
	public void play() {
		...
		while(true) {
			...
			if(input.equals("1")) p.moveUp();
				...
				System.out.println(p.getName() + "님이 게임을 포기하였습니다.");
				break;
			}
			// 현재 좌표
